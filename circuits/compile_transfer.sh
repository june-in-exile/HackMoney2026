...
echo ""
echo "Next steps:"
echo "1. Test the circuit: node generateTransferTestInput.js"
...
echo "     build/transfer_public.json \\"
echo "     build/transfer_proof.json"
echo "4. Copy artifacts to web:"
echo "   mkdir -p ../web/public/circuits/transfer_js"
echo "   cp build/transfer_js/transfer.wasm ../web/public/circuits/transfer_js/"
echo "   cp build/transfer_final.zkey ../web/public/circuits/"
echo "   cp build/transfer_vk.json ../web/public/circuits/"
