...
console.log(`IC points: ${ic_points.length} (expected: 6 for 5 public inputs)`);
...
console.log("- transfer_proof_bytes.hex");
console.log("- transfer_public_inputs_bytes.hex");

// Output as Move vector literals
console.log("\n=== Move literals (for tests) ===");
console.log(`\nconst TRANSFER_VK: vector<u8> = x"${vkBytes.toString("hex")}";`);
console.log(`\nconst TRANSFER_PROOF: vector<u8> = x"${proofBytes.toString("hex")}";`);
console.log(`\nconst TRANSFER_PUBLIC_INPUTS: vector<u8> = x"${publicInputsBytes.toString("hex")}";`);

// Also show individual public inputs for reference
console.log("\n=== Individual Public Inputs ===");
console.log(`merkle_root: ${publicInputs[0]}`);
console.log(`input_nullifier1: ${publicInputs[1]}`);
console.log(`input_nullifier2: ${publicInputs[2]}`);
console.log(`output_commitment1: ${publicInputs[3]}`);
console.log(`output_commitment2: ${publicInputs[4]}`);
