    ...
    <header className="border-b-2 border-gray-900 bg-cyber-dark-bg/90 backdrop-blur-md relative">
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 relative z-10">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 border-2 border-cyber-blue bg-cyber-blue/10 flex items-center justify-center clip-corner">
      ...
      {/* Bottom accent line */}
      <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-cyber-blue/30 to-transparent" />
    </header>
  );
}
